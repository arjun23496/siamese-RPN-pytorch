...
parser.add_argument('--train_path', default='/home/akaruvally/scratch/vot2013', metavar='DIR',
                    help='path to dataset')

parser.add_argument('--weight_dir', default='/home/akaruvally/scratch/weights', metavar='DIR', help='path to weight')

parser.add_argument('--checkpoint_path', default='/home/akaruvally/scratch/weights/weights-0100000.pth.tar', help='resume')
